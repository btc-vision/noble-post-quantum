 ...
 */
class MLDSAInstance implements DSA {
    public readonly info = { type: 'ml-dsa' as const };
    public readonly internal: DSAInternal;
    public readonly lengths: Signer['lengths'];
    ...
    public get primitives(): MLDSAPrimitives {
        return this.#primitives;
    }

    constructor(opts: DilithiumOpts) {
        ...
        this.internal = {
            ...
            sign: (
                ...
                signOpts: SigOpts & DSAInternalOpts = {},
            ) => {
    ...
    public keygen(seed?: Uint8Array) {
        return this.internal.keygen(seed);
    }

    /** Derive the public key from a secret key. */
    public getPublicKey(secretKey: Uint8Array) {
        return this.internal.getPublicKey(secretKey);
    }

    /** Sign a message with FIPS 204 domain separation. */
    public sign(msg: Uint8Array, secretKey: Uint8Array, opts: SigOpts = {}) {
    ...
    public verify(sig: Uint8Array, msg: Uint8Array, publicKey: Uint8Array, opts: VerOpts = {}) {
    ...
    public prehash(hash: CHash) {
        checkHash(hash, this.securityLevel);
        const internal = this.internal;
        return {
            info: { type: 'hashml-dsa' as const },
 ...
 */
export function getDilithium(opts: DilithiumOpts): DSA {
    return new MLDSAInstance(opts);
}

/** ML-DSA-44 for 128-bit security level. Not recommended after 2030, as per ASD. */
export const ml_dsa44: DSA = /* @__PURE__ */ new MLDSAInstance({
    ...PARAMS[2],
    CRH_BYTES: 64,
    TR_BYTES: 64,
    C_TILDE_BYTES: 32,
...
export const ml_dsa65: DSA = /* @__PURE__ */ new MLDSAInstance({
    ...PARAMS[3],
    CRH_BYTES: 64,
    TR_BYTES: 64,
    C_TILDE_BYTES: 48,
...
export const ml_dsa87: DSA = /* @__PURE__ */ new MLDSAInstance({
    ...PARAMS[5],
    CRH_BYTES: 64,
    TR_BYTES: 64,
    C_TILDE_BYTES: 64,
